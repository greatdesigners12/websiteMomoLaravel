...
class ProductController extends Controller
{
    ...
    function createproduct(Request $request){
        ...
        $rules = ['name' => 'required', 'description' => "required", 'category_id' => "required|integer", 'weight' => 'required|integer', 'price' => "required", 'stock' => "required|integer", 'image_product' => 'required'];
    ...
    function updateProduct(Request $request){
        $rules = ['id' => 'required' ,'name' => 'required', 'description' => "required", 'category_id' => "required|integer", 'weight' => 'required|integer', 'price' => "required", 'stock' => "required|integer"];
        $messages = ["required" => "Input :attribute tidak boleh kosong", "integer" => "Input :attribute harus angka"];
        $validator = Validator::make($request->all(), $rules, $messages);
        $validated = $validator->validated();
