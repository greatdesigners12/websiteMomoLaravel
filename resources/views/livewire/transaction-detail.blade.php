                        ...
                        <div class="checkout-info w-100">
                            <div class="checkout-order">
                                ...
                                <div class="checkout-order__item">
                                    <a href="{{route('getProductById', $item->transaction_product->id)}}" class="checkout-order__item-img">
                                    ...
                                    <div class="checkout-order__item-info">
                                        <a class="title6" href="{{route('getProductById', $item->transaction_product->id)}}">{{$item->transaction_product->name}} <span>{{$item->transaction_product->quantity}}x</span></a>
